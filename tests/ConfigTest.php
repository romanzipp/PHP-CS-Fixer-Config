...
class ConfigTest extends TestCase
{
    ...
    {
        $config = Config::make()->in(__DIR__ . '/Files')->preset(new TestPreset())->out();
    ...
    {
        $config = Config::make()->in(__DIR__ . '/Files')->withPreset(new TestPreset())->withPreset(new AdditionalTestPreset())->out();
