...
class PrettyPHP extends AbstractPreset
{
    ...
    {
        return [
            '@Symfony' => true,                         // https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/blob/master/doc/ruleSets/Symfony.rst
            'array_indentation' => true,                // https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/blob/master/doc/rules/whitespace/array_indentation.rst
            // see https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/issues/4487
            'braces' => true,                           // https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/blob/master/doc/rules/basic/braces.rst
            'concat_space' => [                         // https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/blob/master/doc/rules/operator/concat_space.rst
                'spacing' => 'one',
            ],
            'no_superfluous_phpdoc_tags' => false,      // https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/blob/master/doc/rules/phpdoc/no_superfluous_phpdoc_tags.rst
            ...
            'not_operator_with_space' => true,          // https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/blob/master/doc/rules/operator/not_operator_with_space.rst
